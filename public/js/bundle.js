...
exports.logout = exports.login = exports.signupOTP = exports.sendOTP = void 0;
...
var signupOTP = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(email, name, role) {
    var res;
  ...
  return function signupOTP(_x2, _x3, _x4) {
...
var login = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(otp, email) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"submitForms.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateResumeField = exports.uploadResume = exports.renderProfile = void 0;
...
var uploadResume = /*#__PURE__*/function () {
...
var updateResumeField = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(jobId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Congratulations!! successfully applied');
            }
  ...
  return function updateResumeField(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

exports.updateResumeField = updateResumeField;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"geoLocation.js":[function(require,module,exports) {
"use strict";
...
var success = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(position) {
    var latitude, longitude, res, body, anchorTag;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/jobs/".concat(latitude, "/").concat(longitude)
            });
          ...
          case 5:
            ...
            if (res.status === 200) {
              // alert('Done!!');
              (0, _alert.showAlert)('success', 'Done!!');
              body = document.getElementsByTagName('body')[0];
              body.innerHTML = '';
              body.insertAdjacentHTML('afterbegin', res.data);
              anchorTag = document.querySelector('.geo__jobs');
...
var _submitForms = require("./submitForms");
...
var loginLabel = document.querySelector('.login__label');
var loginInput = document.querySelector('.login__input');
var otpLabel = document.querySelector('.otp__label');
var otpInput = document.querySelector('.otp__input');
var updateUser = document.querySelectorAll('.submit__user');
var profileBtn = document.querySelector('.nav__btn--1');
var jobApply = document.querySelectorAll('.job__apply');
var logoutBtn = document.querySelector('.nav__btn--2');
var createJob = document.querySelector('.employer__submit');
var signup = document.querySelector('.signup');
var signupPage = document.querySelector('.signup__page');
var signupSendOtpBtn = document.querySelector('.signup__sendOtp');
var tabButton = document.querySelectorAll('.post__name');
var tabBlock = document.querySelectorAll('.block');
var applicantsPage = document.querySelector('.main__applicants');
var geoLocationBtn = document.querySelector('.geo__jobs');
  ...
  jobApply.forEach(function (el) {
    el.addEventListener('click', function (e) {
      ...
      if (Number(count) === 1) {
        ...
        (0, _alert.showAlert)('error', 'You have applied in all jobs. Try again tomorrow');
      }
...
if (geoLocationBtn) {
  geoLocationBtn.addEventListener('click', /*#__PURE__*/function () {
...
if (applicantsPage) {
  window.addEventListener('load', function () {
    document.querySelector(".candidates__block--0").classList.remove('hidden', 'visibility');
...
if (signup) {
  signupSendOtpBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var email, name, role, res, html;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return (0, _login.signupOTP)(email, name, role);
...
if (updateUser) {
  updateUser.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
